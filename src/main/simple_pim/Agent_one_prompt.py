...
5.  **Process Tool Response:**
    * **Success:** If the tool's response dictionary contains `"status": "success"`, extract the value associated with the `"output"` key. This value is the **raw fetched web content**.
